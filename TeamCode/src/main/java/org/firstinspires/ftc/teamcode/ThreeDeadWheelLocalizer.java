...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1717.2851003876629; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2520.0594040236247; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -518.1933411304553; // x position of the perpendicular encoder (in tick units)
    }
